...
// Modified from: https://github.com/Q-Mobile/QGrid

import SwiftUI

public struct GridView<Data, Content, HeaderContent>: View
where Data : RandomAccessCollection, Content : View, HeaderContent : View, Data.Element : Identifiable {
